"""
API клиент для работы с Open Food Facts.
Приоритет для текстового поиска: Search-a-licious → API V2 → API V1.
"""
import asyncio
import httpx
import logging
...
class OpenFoodFactsClient:
    ...
    def __init__(self):
        # ВАЖНО: OFF блокирует запросы без User-Agent. Укажите данные своего приложения.
        headers = {
            "User-Agent": "NutriMate/1.0 (Python)",
